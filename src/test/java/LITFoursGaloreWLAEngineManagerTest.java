...
public class LITFoursGaloreWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LITFoursGaloreWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LITFoursGaloreWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LITFoursGaloreWLAIW/InitOutcome.xml").getDocumentElement();
