				...
				<lxslt:script lang="javascript">
					...
					function formatJson(jsonContext, translations, prizeTable, prizeValues, prizeNamesDesc)
					{
						...
						if (doBonus)
						{
							...
							r.push('<table border="0" cellpadding="2" cellspacing="1" class="gameDetailsTable">');
							r.push('<tr class="tablehead">');
							r.push('<td colspan="2" style="padding-bottom:10px">' + getTranslationByName("titleBonusSymbsKey", translations) + '</td>');
							r.push('</tr>');
							r.push('<tr class="tablehead">');
							r.push('<td>' + getTranslationByName("keySymbol", translations) + '</td>');
							r.push('<td>' + getTranslationByName("keyDescription", translations) + '</td>');
							...
							for (var symbIndex = 0; symbIndex < bonusLoseSymbs.length; symbIndex++)
							{
								symbSpecial  = bonusLoseSymbs[symbIndex];
								canvasIdStr  = 'cvsBonusKeySymb' + symbSpecial;
								elementStr   = 'eleBonusKeySymb' + symbSpecial;
								symbDesc     = getTranslationByName("keyB" + symbSpecial, translations);
							...
							r.push('<div style="clear:both">');
							r.push('<p>' + getTranslationByName("bgTurns", translations) + '</p>');
